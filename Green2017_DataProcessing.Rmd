...
```{r}
green_data <- read_csv("Green/green_tripdata_2017-01.csv")
summary(green_data)
```
```{r}
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-01.csv")
```
...
## February 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-02.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-02.csv")
```


## March 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-03.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-03.csv")
```


## April 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-04.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-04.csv")
```


## May 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-05.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-05.csv")
```


## June 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-06.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-06.csv")
```
...
## July 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-07.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-07.csv")
```


## September 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-09.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-09.csv")
```


## October 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-10.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-10.csv")
```


## November 2017
```{r}
green_data <- read_csv("Green/green_tripdata_2017-11.csv")
summary(green_data)
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-11.csv")
```
...
```{r}
write_csv(green_monthly, path="Green/Green_Data_Clean/green_2017-12.csv")
```
